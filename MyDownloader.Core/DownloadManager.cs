...
namespace MyDownloader.Core
{
    public class DownloadManager
    {
        ...
        public Downloader Add(ResourceLocation rl, ResourceLocation[] mirrors, string localFile, int segments, bool autoStart, ulong fs_id)
        {
            Downloader d = new Downloader(rl, mirrors, localFile, segments, fs_id);
            Add(d, autoStart);
